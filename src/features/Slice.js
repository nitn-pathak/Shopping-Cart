...
export const Slice = createSlice({
       ...
       Allitem:(state)=>{
          ...
          
          {
            ...
            const{price,quantity} = cartitem;
                       ...
                       carttotal.totalprice = carttotal.totalprice+itemtotal;
 ...
 export const {addtocart,Allitem,removeitem,increaseItem,decreaseItem} = Slice.actions;
